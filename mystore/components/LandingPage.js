...
class LandingPage extends React.Component {
    ...
    navigateToProductDetails(){
        Router.push("/productdetails").then(() => {
            Router.reload();
        });
    }
    render() {
        return (
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-15 mx-auto">
                    ...
                    <div className="h-56 mb-5 sm:h-64 xl:h-80 2xl:h-96">
                        <Carousel>
                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/4 md:w-1/2 p-4 w-full cursor-pointer" onClick={this.navigateToProductDetails.bind(this)}>
                        ...
                        <div className="lg:w-1/4 md:w-1/2 p-4 w-full cursor-pointer">
                            <a className="block relative h-48 rounded overflow-hidden">
                                <img alt="ecommerce" className="object-cover object-center w-full h-full block" src="https://dummyimage.com/422x262" />                        </a>
                            <div className="mt-4">
                                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
